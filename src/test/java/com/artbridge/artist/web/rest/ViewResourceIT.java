...
import com.artbridge.artist.presentation.rest.ViewResource;
...
//        assertThat(testView.getMember()).isEqualTo(DEFAULT_VO_MEMBER);
//    }
//
//    @Test
//    @Transactional
...
//        View testView = viewList.get(viewList.size() - 1);
//        assertThat(testView.getMember()).isEqualTo(UPDATED_VO_MEMBER);
//    }
//
//    @Test
//    @Transactional
