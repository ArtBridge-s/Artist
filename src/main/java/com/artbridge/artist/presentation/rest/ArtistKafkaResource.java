...
@RestController
@RequestMapping("/api/artist-kafka")
public class ArtistKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ArtistKafkaResource.class);
    ...
    public ArtistKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
